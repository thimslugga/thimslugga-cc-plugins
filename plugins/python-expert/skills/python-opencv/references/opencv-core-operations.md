# OpenCV Core Operations Reference

Detailed reference for OpenCV image and video I/O, filtering, contours, transformations, and feature detection. See SKILL.md for the lean orchestrator overview.
