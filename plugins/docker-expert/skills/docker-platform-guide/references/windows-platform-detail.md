...
Windows container types (Server containers, Hyper-V, process isolation), WSL2 integration, image variants (`nanoserver`, `windowsservercore`), licensing, networking peculiarities, mount semantics, and
